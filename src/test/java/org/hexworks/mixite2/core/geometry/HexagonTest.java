...
import static org.hexworks.mixite2.core.geometry.Point.fromPosition;
...
class HexagonTest 
{
    ...
    private final List<Point> EXPECTED_FLAT_POINTS = Arrays.asList(
            fromPosition(50.0, 78.0), 
            fromPosition(45.0, 87.0),
            fromPosition(35.0, 87.0),
            fromPosition(30.0, 78.0), 
            fromPosition(35.0, 69.0), 
            fromPosition(45.0, 69.0));
    private final List<Point> EXPECTED_POINTY_POINTS =  Arrays.asList(
            fromPosition(78.0, 60.0), 
            fromPosition(69.0, 65.0), 
            fromPosition(61.0, 60.0), 
            fromPosition(61.0, 50.0), 
            fromPosition(69.0, 45.0), 
            fromPosition(78.0, 50.0));
